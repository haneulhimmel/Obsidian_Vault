- Design Prelab: Outputs
	1. Pump: $\mathrm{\overline{Empty}}$ & $\mathrm{\overline{Hot}}$ & $\mathrm{\overline{Cold}}$ & Dry
	2. Heater: (Cold & $\overline{Hot}$) | (Motion & $\mathrm{\overline{Hot}}$ & $\mathrm{\overline{Cold}}$) 
	3. Fan: Hot & $\mathrm{\overline{Cold}}$
	4. Lights: (Dusk | Motion) & $\mathrm{\overline{(Cold\ \&\ Hot)}}$ (Lowest Priority)
	5. Alarm: (Hot & Cold) | (Empty) (Highest Priority)
